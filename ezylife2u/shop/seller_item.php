			...
			<div class="wrapper wrapper-content animated fadeInRight">
				...
				<div class="row">
					...
					<div class="col-md-3 text-center">
						<a data-toggle="modal" class="btn btn-primary btn-lg btn-block" href="#add_selleritem"> &nbsp;Add Item</a>
				...
				<div class="modal inmodal" id="add_selleritem" tabindex="-1" role="dialog"  aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content animated fadeIn">
							<form role="form" id="form" action="soap_func.php?type=selleradditem&tb=user" method="post" enctype="multipart/form-data">
								...
								<div class="table-responsive">
									...
									<tbody>
									    <?php 
											...
											$result = $db->where('*','mv_item','mv_user_id',$thisid);
											foreach($result as $row){
											?>
										...
										<tr>
											...
											<td><?php echo $row["mv_item_amt"]; ?></td>
											...
											<td class="text-center">
												...
												<a data-remote="ajax/shop_item_edit.php?p=<?php echo $row['mv_item_id']; ?>&q=<?php echo $user["mv_user_id"]; ?>" class="btn btn-white btn-xs" data-toggle="modal" data-target="#myModal">Edit</a>
				...
				<?php  
    			    ...
    			    {
    			        echo "YOU ARE NOT WHOLESALER, U CANNOT LANDING THIS PAGE";
    			    }
    			?>
