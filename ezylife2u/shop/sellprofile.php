...
<body>
    ...
    }else
    {
        $userpass = $user["mv_user_passport"];
									...
									<h5>
										Passport : <?php echo $user["mv_user_passport"]; ?>
									</h5>
									<h5>
										State : <?php
									...
									<div class="user-button">
										<div class="row">
											...
											<a data-remote="ajax/sellerprofile_edit.php?p=<?php echo $user['mv_user_id']; ?>" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#myModal"><i class="fa fa-gear"></i>Edit Profile</a>
