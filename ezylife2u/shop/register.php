...
<head>
    ...
    $user = $db->where('*','mv_user','mv_user_id',$decpass);
    $user = $user[0];
...
?>
    ...
    <title>Ezylife2u | Link Register</title>
    ...
    <div class="text-center loginscreen animated fadeInDown ">
        <div>
			...
			<div class="middle-box ">
				...
				<p>Register</p>
				<form role="form" id="form_user" action="api/register.php?type=userregister&success=1" method="post" enctype="multipart/form-data">
		...
		<div class="hr-line-dashed"></div>
									...
									<div class="form-group" hidden><label>Fullname</label> <input type="text" placeholder="Enter fullname" class="form-control" name="fname"></div>
									<div class="form-group"><label>Email</label> <input type="email" placeholder="Enter email" class="form-control" name="email"></div>
									<div class="form-group"><label>Referral Code</label> <input type="text" placeholder="Enter referral code" class="form-control" id="chkRef2" name="upline" readonly value="<?php echo $user["mv_user_code"]; ?> "></div>
									<div class="form-group" hidden><label>NRIC</label> <input type="text" placeholder="eg. 931120065555" class="form-control" name="ic"></div>
									<div class="form-group" hidden><label>Phone Number</label> <input type="text" placeholder="eg. 0161234567" class="form-control" name="phone"></div>
									<div class="form-group" hidden><label>Passport (Optional)</label> <input type="text" placeholder="Enter passport" class="form-control" name="passport"></div>
		...
		<div class="modal-footer">
			...
			<button type="submit" class="btn btn-white" name="btnsubmituser" >Submit</button>
				...
				<p class="m-t"> <small>Developed By Ezylife2u &copy; 2014</small> </p>
			</div>
        </div>
    </div>
