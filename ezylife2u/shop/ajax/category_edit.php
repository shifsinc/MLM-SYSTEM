...
<div class="modal-body">
										...
										<div class="row">
											<div class="col-lg-12 ">
												...
												<form role="form" id="form_edit" action="soap_func.php?type=editscategory&tb=user" method="post" enctype="multipart/form-data">
													<input type="hidden" name="token" value="<?php echo $token; ?>" />
													<div class="hr-line-dashed"></div>
													<div class="form-group "><label>Name</label>
														<div class="col-sm-10"><input type="text" placeholder="Category Name" class="form-control" name="cname" value="<?php echo $cate["mv_category_name"]; ?>" id='chkcategoryname_ajax'></div>
													</div>
			...
			<div class="row">
				<div class="i-checks col-md-3 text-center"><input type="radio" name="status" value="0"  <?php if ($cate["mv_category_status"] == 0): ?>
					checked="checked"
				<?php endif ?>> Block</div>
				<div class="i-checks col-md-3 text-center"><input type="radio" name="status" value="1"  <?php if ($cate["mv_category_status"] == 1): ?>
					checked="checked"
		...
		<button type="submit" class="btn btn-white" name="btnsubmitcategory" value="<?php echo $cate["mv_category_id"]; ?>">Submit</button>
