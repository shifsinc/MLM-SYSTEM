				...
				<div class="modal inmodal" id="add_item" tabindex="-1" role="dialog"  aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content animated fadeIn">
							<form role="form" id="form" action="soap_func.php?type=shopadditem&tb=user" method="post" enctype="multipart/form-data">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												...
												<a data-remote="ajax/shop_item_edit.php?p=<?php echo $row['mv_item_id']; ?>" class="btn btn-white btn-xs" data-toggle="modal" data-target="#myModal">Edit</a>
